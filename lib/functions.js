...
/**
 * Retrieve membership objects relating to a user
 ...
 */
Organization.getMembersWithPermission = function (organizationId, permissions) {
 ...
 */
Organization.userHasPermissions = function (organizationId, permissions, userId) {
  return Collections.Membership.find({
    organization: organizationId,
    userId: userId,
    permissions: {
